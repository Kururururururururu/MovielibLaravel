    ...
    <div class="container">
        ...
        <div class="movie-container">
            ...
            <div class="movie-info">
                <div class="movie-info-item"><p class="movie-info-item-title">Release Date:</p>
                    <p class="movie-info-item-value">{{$movie->release_date}}</p></div>
                <div class="movie-info-item"><p class="movie-info-item-title">Runtime:</p>
                    <p class="movie-info-item-value">{{$movie->runtime}} minutes</p></div>
                <div class="movie-info-item"><p class="movie-info-item-title">Genres:</p>
                ...
                <div class="movie-info-item"><p class="movie-info-item-title">Reviews:</p>
                    <p class="movie-info-item-value">{{$movie->vote_count}} reviews</p></div>
                <div class="movie-info-item"><p class="movie-info-item-title">Language:</p>
                    <p class="movie-info-item-value">
                        @foreach($movie->spoken_languages as $language)
                            {{$language->english_name}}
                        @endforeach
                    </p></div>
                <div class="movie-info-item"><p class="movie-info-item-title">Adult:</p>
                    <p class="movie-info-item-value">
                        @if($movie->adult)
                ...
                <div class="movie-info-item"><p class="movie-info-item-title">Budget:</p>
                    <p class="movie-info-item-value">
                ...
                <div class="movie-info-item"><p class="movie-info-item-title">Revenue:</p>
                    <p class="movie-info-item-value">
                ...
                <div class="movie-info-item"><p class="movie-info-item-title">Status:</p>
            ...
            <div>
                ...
                <div class="movie-info-extra" id="comments_tab" style="display: none">
                    ...
                    <form class="comment-form" id="comment-form">
                        <label for="comment-input">Commenting as <code>&ltuser&gt</code></label>
