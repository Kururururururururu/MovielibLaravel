...
addToWatchlistBtn.addEventListener('click', () => {
    const isAdded = addToWatchlistBtn.attributes.getNamedItem('data-watchlist').value === 'true';
    ...
    if (isAdded) {
        ...
        addToWatchlistBtn.attributes.getNamedItem('data-watchlist').value = 'false';
    } else {
        addToWatchlistBtn.innerText = 'Adding to Watchlist...';
        addToWatchlist(movieId);
        addToWatchlistBtn.attributes.getNamedItem('data-watchlist').value = 'true';
    }
})
